...
/**
 * Created by Sherlock·Holmes on 2020/4/21
 */
@Entity
public class HukuFind {
    ...
    @Generated(hash = 553295454)
    public HukuFind(String id, int status, String name, String relations,
