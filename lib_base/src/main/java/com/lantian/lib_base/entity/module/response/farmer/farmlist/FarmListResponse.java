...
/**
 * Created by Sherlock·Holmes on 2020-03-21
 */
@Entity(indexes = {@Index(value = "user_id DESC,state DESC,DBuser_id")})
public class FarmListResponse implements Serializable {
     ...
     * nickname : null
     * sex : 1
     * address : 苏米图苏木小额尔和图嘎查布日都小队050号
     * id_card : 152725197004201216
     * age : 50
     * avatar : http://admin.fengtaiiot.com/logo.png
     * open_id : null
     * user_api_key : null
     ...
     * appsecret :
     * login_ip : null
     * created_at : 2019-11-17 16:08:15
     * updated_at : null
     * deleted_at : null
     * xian : 95
     * shi : 86
    ...
    @Generated(hash = 791503602)
    public FarmListResponse(String DBuser_id, int state, String user_id,
            String username, String password, String phone, String email,
            String nickname, String sex, String address, String id_card, String age,
            String avatar, String open_id, String user_api_key,
            String company_api_key, String fial_time, String is_admin,
            String register_code, String flag_code, String last_code,
            String smx_username, String smx_password, String iot_username,
            String iot_password, String appkey, String appsecret, String login_ip,
            String created_at, String updated_at, String deleted_at, String xian,
            String shi, String sheng, String address_id, String smx_id,
            String smx_type, String smx_ticket, String usertype_id, String lng,
            String lat, String updated_time, String staff_id, String name,
            String addtime, String status, String syte_id) {
