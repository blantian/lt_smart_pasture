package com.lantian.lib_base.entity.module.response.farmer.farmmsg;
...
public class FarmMsgResponse {
    ...
    @Generated(hash = 535989065)
    public FarmMsgResponse(String id, @NotNull String user_id, int status,
            String name, String relations, String tel, String labour_type,
            String idcard_front, String idcard_side, String idcard_front_angle,
            String idcard_side_angle, String idcard_name, String idcard_gender,
            String birth_date, String idcard, String sheng, String shi, String xian,
            String xiangxi, String dizhi, String addtime, String update_time,
            String shenhe, String age, String created_at) {
        this.id = id;
    ...
    @Generated(hash = 307450774)
    public FarmMsgResponse() {
    }
