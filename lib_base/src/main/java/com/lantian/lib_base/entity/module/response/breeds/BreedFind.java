...
/**
 * Created by Sherlock·Holmes on 2020/4/15
 */
@Entity
public class BreedFind implements Serializable {
     ...
     * breedclass_id : 10
     * number : 150
     * acquisition_time : 2020-04-23 00:00:00
     * title : 山羊
     * age : 2
     * become_time : 2020-04-23 00:00:00
     * become_price : 15000.00
     * price : 15000.00
     * addtime : 2020-04-15 16:04:52
     * shenhe : null
     * img : http://admin.fengtaiiot.com/uploadImage/5e96c79c427d9.jpg
     * common : 0
     * mother : 0
     * sheng : 未选择省份
     * shi : 未选择市
    ...
    @Generated(hash = 1881429961)
    public BreedFind(int status, String id, String user_id, String hukou_id,
            ...
            int typet, String variety, String supplier, String gong, String mu) {
        this.status = status;
        this.id = id;
