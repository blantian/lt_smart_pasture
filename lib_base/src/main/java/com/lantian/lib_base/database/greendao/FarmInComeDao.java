...
/** 
 * DAO for table "FARM_IN_COME".
*/
public class FarmInComeDao extends AbstractDao<FarmInCome, String> {

    public static final String TABLENAME = "FARM_IN_COME";

    /**
     * Properties of entity FarmInCome.<br/>
    ...
    public FarmInComeDao(DaoConfig config) {
        super(config);
    }
    
    public FarmInComeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FARM_IN_COME\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FARM_IN_COME\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, FarmInCome entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, FarmInCome entity) {
        stmt.clearBindings();
    ...
    @Override
    public FarmInCome readEntity(Cursor cursor, int offset) {
        FarmInCome entity = new FarmInCome( //
    ...
    @Override
    public void readEntity(Cursor cursor, FarmInCome entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(FarmInCome entity, long rowId) {
        return entity.getUserid();
    }
    
    @Override
    public String getKey(FarmInCome entity) {
        if(entity != null) {
            return entity.getUserid();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(FarmInCome entity) {
