...
/** 
 * DAO for table "ADD_BREED".
*/
public class AddBreedDao extends AbstractDao<AddBreed, String> {

    public static final String TABLENAME = "ADD_BREED";

    /**
     * Properties of entity AddBreed.<br/>
    ...
    public AddBreedDao(DaoConfig config) {
        super(config);
    }
    
    public AddBreedDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ADD_BREED\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ADD_BREED\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, AddBreed entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, AddBreed entity) {
        stmt.clearBindings();
    ...
    @Override
    public AddBreed readEntity(Cursor cursor, int offset) {
        AddBreed entity = new AddBreed( //
    ...
    @Override
    public void readEntity(Cursor cursor, AddBreed entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(AddBreed entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(AddBreed entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(AddBreed entity) {
