...
/** 
 * DAO for table "HUKU_FIND".
*/
public class HukuFindDao extends AbstractDao<HukuFind, String> {

    public static final String TABLENAME = "HUKU_FIND";

    /**
     * Properties of entity HukuFind.<br/>
    ...
    public HukuFindDao(DaoConfig config) {
        super(config);
    }
    
    public HukuFindDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HUKU_FIND\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"HUKU_FIND\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, HukuFind entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, HukuFind entity) {
        stmt.clearBindings();
    ...
    @Override
    public HukuFind readEntity(Cursor cursor, int offset) {
        HukuFind entity = new HukuFind( //
    ...
    @Override
    public void readEntity(Cursor cursor, HukuFind entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(HukuFind entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(HukuFind entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(HukuFind entity) {
