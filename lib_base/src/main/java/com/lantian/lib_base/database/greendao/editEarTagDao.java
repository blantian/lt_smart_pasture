...
/** 
 * DAO for table "EDIT_EAR_TAG".
*/
public class editEarTagDao extends AbstractDao<editEarTag, String> {

    public static final String TABLENAME = "EDIT_EAR_TAG";

    /**
     * Properties of entity editEarTag.<br/>
    ...
    public editEarTagDao(DaoConfig config) {
        super(config);
    }
    
    public editEarTagDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"EDIT_EAR_TAG\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_EDIT_EAR_TAG_ID_EARTAG_ID ON \"EDIT_EAR_TAG\"" +
                " (\"ID\" ASC,\"EARTAG_ID\" ASC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"EDIT_EAR_TAG\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, editEarTag entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, editEarTag entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getStatus());
    ...
    @Override
    public editEarTag readEntity(Cursor cursor, int offset) {
        editEarTag entity = new editEarTag( //
    ...
    @Override
    public void readEntity(Cursor cursor, editEarTag entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(editEarTag entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(editEarTag entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(editEarTag entity) {
