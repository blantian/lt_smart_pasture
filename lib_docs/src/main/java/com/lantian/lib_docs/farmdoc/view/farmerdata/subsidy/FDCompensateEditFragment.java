...
public class FDCompensateEditFragment extends BaseFragmen implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_fdcompensate_edit, null);
        initView(view);
        return view;
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_save){
            ...
            RetrofitHelper.getApiService().delCompensate("[" + id + "]").enqueue(new MyCallBack<String>() {
                @Override
