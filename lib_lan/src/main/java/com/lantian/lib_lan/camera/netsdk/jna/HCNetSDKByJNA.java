...
public interface HCNetSDKByJNA extends Library {
    ...
    public static class NET_DVR_PLATE_INFO extends Structure{
        ...
        protected List<String> getFieldOrder() {
            ...
            return Arrays.asList("byPlateType", "byColor", "byBright", "byLicenseLen", "byEntireBelieve", "byRegion",
                    "byCountry", "byArea", "byPlateSize", "byRes", "sPlateCategory", "dwXmlLen", "pXmlBuf", "struPlateRect", "sLicense", "byBelieve");
        }
    ...
    public static class NET_ITS_PICTURE_INFO extends Structure{
        ...
        protected List<String> getFieldOrder() {
            ...
            return Arrays.asList("dwDataLen", "byType", "byDataType", "byCloseUpType", "byPicRecogMode", "dwRedLightTime",
                    "byAbsTime", "struPlateRect", "struPlateRecgRect", "pBuffer", "dwUTCTime", "byCompatibleAblity", "byTimeDiffFlag", "cTimeDifferenceH", "cTimeDifferenceM", "byRes2");
        }
    }
    ...
    public static class NET_DVR_ACS_EVENT_INFO extends Structure {
        ...
        protected List<String> getFieldOrder() {
            // TODO Auto-generated method stub
            return Arrays.asList("dwSize", "byCardNo", "byCardType", "byWhiteListNo", "byReportChannel", "byCardReaderKind",
                    "dwCardReaderNo","dwDoorNo", "dwVerifyNo", "dwAlarmInNo", "dwAlarmOutNo","dwCaseSensorNo",
                    "dwRs485No","dwMultiCardGroupNo","wAccessChannel","byDeviceNo","byDistractControlNo",
                    "dwEmployeeNo","wLocalControllerID","byInternetAccess","byType","byMACAddr",
                    "bySwipeCardType","byRes2","dwSerialNo","byChannelControllerID","byChannelControllerLampID",
    ...
    public static class NET_VCA_RULE_ALARM extends Structure
    {
        ...
        protected List<String> getFieldOrder() {
            ...
            return Arrays.asList("dwSize", "dwRelativeTime", "dwAbsTime", "struRuleInfo", "struTargetInfo", "struDevInfo",
                    "dwPicDataLen", "byPicType", "byRelAlarmPicNum", "bySmart", "byPicTransType", "dwAlarmID", "wDevInfoIvmsChannelEx", "byRelativeTimeFlag", "byAppendInfoUploadEnabled", "pAppendInfo", "pImage");
        }
    }
    ...
    public static class NET_DVR_DEVICEINFO_V30 extends Structure
    {
        ...
        protected List<String> getFieldOrder() {
            ...
            return Arrays.asList("sSerialNumber", "byAlarmInPortNum", "byAlarmOutPortNum",
                    "byDiskNum", "byDVRType", "byChanNum", "byStartChan", "byAudioChanNum", "byIPChanNum",
                    "byZeroChanNum","byMainProto","bySubProto","bySupport","bySupport1","bySupport2","wDevType","bySupport3",
                    "byMultiStreamProto","byStartDChan","byStartDTalkChan","byHighDChanNum","bySupport4","byLanguageType","byVoiceInChanNum","byStartVoiceInChanNo",
                    "byRes3","byMirrorChanNum","wStartMirrorChanNo","byRes2");
        }
    }
    ...
    public static class NET_DVR_USER_LOGIN_INFO extends Structure
    {
        ...
        protected List<String> getFieldOrder() {
            ...
            return Arrays.asList("sDeviceAddress", "byRes1", "wPort", "sUserName", "sPassword",
                    "cbLoginResult", "pUser", "bUseAsynLogin", "byRes", "byLoginMode", "byRes2");
        }
    }
    ...
    public static class NET_VCA_FACESNAP_RESULT extends Structure
    {
        ...
        protected List<String> getFieldOrder() {
            ...
            return Arrays.asList("dwSize", "dwRelativeTime", "dwAbsTime", "dwFacePicID", "dwFaceScore", "struTargetInfo",
                    ...
                    "wDevInfoIvmsChannelEx", "byFacePicQuality", "byUIDLen", "byRes1", "byAddInfo", "pUIDBuffer", "pAddInfoBuffer", "byTimeDiffFlag", "cTimeDifferenceH", "cTimeDifferenceM", "byBrokenNetHttp", "pBuffer1", "pBuffer2");
        }
    }
...
//
    ...
    public static class NET_DVR_LOCAL_GENERAL_CFG extends Structure{
        ...
        protected List<String> getFieldOrder() {
            // TODO Auto-generated method stub
            return Arrays.asList("byExceptionCbDirectly", "byNotSplitRecordFile", "byResumeUpgradeEnable", "byAlarmJsonPictureSeparate", "byRes", "i64FileSize", "dwResumeUpgradeTimeout", "byRes1");
        }
    }
    ...
    public static class NET_DVR_SCENE_INFO  extends Structure {
        public int dwSceneID;              //����ID, 0 - ��ʾ�ó�����Ч
    ...
    public static class NET_DVR_DIRECTION extends Structure {
        ...
        public NET_DVR_PTZPOS  struStartPoint = new NET_DVR_PTZPOS();             // ������ʼ��
    ...
    public static class NET_DVR_AID_INFO  extends Structure {
        ...
        public NET_DVR_DIRECTION struDirect = new NET_DVR_DIRECTION(); // ����ָ������
        public byte bySpeedLimit; //����ֵ����λkm/h[0,255]
        public byte byCurrentSpeed; //��ǰ�ٶ�ֵ����λkm/h[0,255]
        public byte byVehicleEnterState; //��������״̬��0- ��Ч��1- ʻ�룬2- ʻ��
        public byte[] byRes2 = new byte[37];  // �����ֽ�
